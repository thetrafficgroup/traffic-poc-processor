...
def process_video(VIDEO_PATH, LINES_DATA, MODEL_PATH="best.pt", study_type="TMC", video_uuid=None, progress_callback=None, minute_batch_callback=None, generate_video_output=False, output_video_path=None, trim_periods=None, night_model_path=None, video_start_time=None):
    """
    ...
    if study_type.upper() == "TMC":
        return tmc_process_video(VIDEO_PATH, LINES_DATA, MODEL_PATH, video_uuid, progress_callback,
                                ...
                                night_model_path=night_model_path, video_start_time=video_start_time)
