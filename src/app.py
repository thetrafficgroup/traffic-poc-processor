...
def process_video(VIDEO_PATH, LINES_DATA, MODEL_PATH="best.pt", study_type="TMC", video_uuid=None, progress_callback=None, minute_batch_callback=None, generate_video_output=False, output_video_path=None, trim_periods=None, pedestrian_model_path=None, truck_classifier_model_path=None, rear_model_path=None, axle_detector_model_path=None):
    """
    ...
    Args:
        ...
        truck_classifier_model_path: Optional path to truck subtype classifier model
